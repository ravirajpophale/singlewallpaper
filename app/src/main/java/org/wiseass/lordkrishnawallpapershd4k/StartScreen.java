...
public class StartScreen extends AppCompatActivity implements CardView.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isNetworkConnected())
            ...
            androidx.appcompat.app.AlertDialog.Builder build = new androidx.appcompat.app.AlertDialog.Builder(StartScreen.this);
            build
    ...
    public void initVals() {
        ...
        ed = pref.edit();
        playa = findViewById(R.id.cvPlayer);
        ...
        newUpdates = findViewById(R.id.newUpdates);
        newUpdates.setOnClickListener(this);

        adholder = findViewById(R.id.adholder);
        //Aug27New
        ivAd = findViewById(R.id.adimage);
    ...
    class MyAsyncTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                BufferedReader bReader2 = new BufferedReader(new InputStreamReader(inputStream2, StandardCharsets.UTF_8), 8);
